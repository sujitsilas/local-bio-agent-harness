...
for sub in SUBTYPES:
    ...
    for i, tp in enumerate(valid):
        draw_volcano(axes_flat[i], de_recr_sub[sub][tp], f"MΦ-Recruited · {sub}\n{tp}")
    ...
    print(f"Saved volcano: MΦ-Recruited · {sub}")
