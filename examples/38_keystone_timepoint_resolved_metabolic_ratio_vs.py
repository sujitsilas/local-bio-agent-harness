...
COMPARTMENTS = [x for x in [find('inflamm'), find('recruit')] if x]
...
fig.subplots_adjust(left=0.11, right=0.93, bottom=0.16, top=0.88, wspace=0.06, hspace=0.10)
...
fig.savefig(f'{FIG}/mac_metabolicratio_vs_recr2res_infmono_recruited_x_timepoint.pdf', dpi=300, bbox_inches='tight')
fig.savefig(f'{FIG}/mac_metabolicratio_vs_recr2res_infmono_recruited_x_timepoint.png', dpi=300, bbox_inches='tight')
